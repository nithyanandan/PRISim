...
if antenna_file is not None:
    ...
    if array_layout not in ['MWA-128T', 'HERA-7', 'HERA-19', 'HERA-37', 'HERA-61', 'HERA-91', 'HERA-127', 'HERA-169', 'HERA-217', 'HERA-271', 'HERA-331', 'PAPER-64', 'PAPER-128', 'HIRAX-1024', 'CIRC']:
    ...
    elif array_layout == 'PAPER-128':
        ant_locs, ant_label = RI.rectangle_generator([30.0, 4.0], [16, 8])
