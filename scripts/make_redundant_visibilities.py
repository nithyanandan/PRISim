...
if __name__ == '__main__':
    ...
    input_group.add_argument('-p', '--parmsfile', dest='parmsfile', default=None, type=file, required=False, help='File specifying simulation parameters')
    ...
    if simbl.shape[0] == bl.shape[0]:
        ...
        inp_blstr = ['{0[0]:.2f}_{0[1]:.3f}_{0[2]:.3f}'.format(lo) for lo in zip(bl_length,inp_blza,bl_orientation)]
