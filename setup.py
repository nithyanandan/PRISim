...
setup(name='PRISim',
    ...
    install_requires=['astropy>=1.0, <3.0', 'astroutils>=0.1.0', 'healpy>=1.5.3',
                      'ipdb>=0.6.1', 'matplotlib>=1.4.3, <3.0', 'mpi4py>=1.2.2',
                      'numpy>=1.8.1', 'progressbar>=2.3', 'psutil>=2.2.1',
                      'pyephem>=3.7.5.3', 'pyyaml>=3.11', 'scipy>=0.15.1',
                      'h5py>=2.6.0', 'pyuvdata>=1.1', 'gdown'],
    setup_requires=['astropy>=1.0, <3.0', 'astroutils>=0.1.0', 'healpy>=1.5.3',
                    'ipdb>=0.6.1', 'matplotlib>=1.4.3, <3.0', 'mpi4py>=1.2.2',
                    'numpy>=1.8.1', 'progressbar>=2.3', 'psutil>=2.2.1',
                    'pyephem>=3.7.5.3', 'pytest-runner', 'pyyaml>=3.11',
                    'scipy>=0.15.1', 'h5py>=2.6.0', 'pyuvdata>=1.1',
                    'gdown'],
