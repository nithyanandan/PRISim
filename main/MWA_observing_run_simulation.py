...
t_snap = 2.0 * 60.0 # in seconds 
t_obs = 0.1 * 3600.0 # in seconds
pointing_init = [0.0, intrfrmtr.latitude]
lst_init = 0.0 * 15.0 # in degrees

intrfrmtr.observing_run(pointing_init, skymod, t_snap, t_obs, chans, bpass, Tsys, lst_init, fov_radius=30.0, mode=obs_mode, freq_scale='GHz')
