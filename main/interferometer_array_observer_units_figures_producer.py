...
if plot_05 or plot_06 or plot_07 or plot_09 or plot_16:
    ...
    for j in range(len(fhd_obsid)):
        ...
        fhd_k_perp = 2 * NP.pi * fhd_bl_length / (FCNST.c/freq) / cosmodel.comoving_transverse_distance(z=redshift).value
        ...
        fhd_k_prll = 2 * NP.pi * fhd_delays * cosmodel.H0.value * CNST.rest_freq_HI * cosmodel.efunc(z=redshift) / FCNST.c / (1+redshift)**2 * 1e3
    ...
    if plot_07 or plot_08:
        ...
        if plot_07:
            ...
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'multi_baseline_CLEAN_noisy_visibilities_sim_data_snr_log_ratio_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_'+fg_str+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.png', bbox_inches=0)
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'multi_baseline_CLEAN_noisy_visibilities_sim_data_snr_log_ratio_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_'+fg_str+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.eps', bbox_inches=0)
...
if plot_10 or plot_11 or plot_12 or plot_13 or plot_14:
    ...
    if plot_10:
        ...
        fig, axs = PLT.subplots(n_snaps, sharex=True, sharey=True, figsize=(6,6))
        for j in xrange(n_snaps):
            imdspec = axs[j].pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e3, vmax=dspec_max))
        ...
        big_axr.set_xticks([])
        big_axr.set_yticks([])
        big_axr.set_ylabel(r'$k_\parallel$ [$h$ Mpc$^{-1}$]', fontsize=16, weight='medium', labelpad=30)
        ...
        for j in xrange(n_snaps):
            fig = PLT.figure(figsize=(6,6))
            ax = fig.add_subplot(111)
            imdspec = ax.pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e4, vmax=dspec_max))
            horizonb = ax.plot(truncated_ref_bl_length, 1e6*min_delay.ravel(), color='white', ls=':', lw=1.5)
            horizont = ax.plot(truncated_ref_bl_length, 1e6*max_delay.ravel(), color='white', ls=':', lw=1.5)
            ax.set_ylim(0.9*NP.amin(clean_lags*1e6), 0.9*NP.amax(clean_lags*1e6))
            ax.set_aspect('auto')
        ...
        fig, axs = PLT.subplots(n_snaps, sharex=True, sharey=True, figsize=(6,6))
        for j in xrange(n_snaps):
            imdspec = axs[j].pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(dsm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e6, vmax=dspec_max))
            horizonb = axs[j].plot(truncated_ref_bl_length, 1e6*min_delay.ravel(), color='white', ls=':', lw=1.5)
            horizont = axs[j].plot(truncated_ref_bl_length, 1e6*max_delay.ravel(), color='white', ls=':', lw=1.5)
            axs[j].set_ylim(0.9*NP.amin(clean_lags*1e6), 0.9*NP.amax(clean_lags*1e6))
            axs[j].set_aspect('auto')
        ...
        for j in xrange(n_snaps):
            fig = PLT.figure(figsize=(6,6))
            ax = fig.add_subplot(111)
            imdspec = ax.pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(dsm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e4, vmax=dspec_max))
            horizonb = ax.plot(truncated_ref_bl_length, 1e6*min_delay.ravel(), color='white', ls=':', lw=1.5)
            horizont = ax.plot(truncated_ref_bl_length, 1e6*max_delay.ravel(), color='white', ls=':', lw=1.5)
            ax.set_ylim(0.9*NP.amin(clean_lags*1e6), 0.9*NP.amax(clean_lags*1e6))
            ax.set_aspect('auto')
        ...
        fig, axs = PLT.subplots(n_snaps, sharex=True, sharey=True, figsize=(6,6))
        for j in xrange(n_snaps):
            imdspec = axs[j].pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(csm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e6, vmax=dspec_max))
            horizonb = axs[j].plot(truncated_ref_bl_length, 1e6*min_delay.ravel(), color='white', ls=':', lw=1.5)
            horizont = axs[j].plot(truncated_ref_bl_length, 1e6*max_delay.ravel(), color='white', ls=':', lw=1.5)
            axs[j].set_ylim(0.9*NP.amin(clean_lags*1e6), 0.9*NP.amax(clean_lags*1e6))
            axs[j].set_aspect('auto')
        ...
        for j in xrange(n_snaps):
            fig = PLT.figure(figsize=(6,6))
            ax = fig.add_subplot(111)
            imdspec = ax.pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(csm_cc_skyvis_lag[:-1,:-1,j].T), norm=PLTC.LogNorm(vmin=1e4, vmax=dspec_max))
            horizonb = ax.plot(truncated_ref_bl_length, 1e6*min_delay.ravel(), color='white', ls=':', lw=1.5)
            horizont = ax.plot(truncated_ref_bl_length, 1e6*max_delay.ravel(), color='white', ls=':', lw=1.5)
            ax.set_ylim(0.9*NP.amin(clean_lags*1e6), 0.9*NP.amax(clean_lags*1e6))
            ax.set_aspect('auto')
        ...
        for blid in select_bl_id:
            fig, axs = PLT.subplots(n_snaps, sharex=True, sharey=True, figsize=(6,6))
            for j in xrange(n_snaps):
                axs[j].plot(1e6*clean_lags, NP.abs(dsm_cc_skyvis_lag[ref_bl_id == blid,:,j]).ravel(), 'k:', lw=2, label='Diffuse')
                axs[j].plot(1e6*clean_lags, NP.abs(csm_cc_skyvis_lag[ref_bl_id == blid,:,j]).ravel(), 'k--', lw=2, label='Compact')
                axs[j].plot(1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[ref_bl_id == blid,:,j]).ravel(), 'k-', lw=2, label='Both')
                ...
                dspec_llim[NP.logical_not(valid_ind)] = 10**4.3
                dspec_llim[small_delays_EoR_window[:,truncated_ref_bl_id==blid].ravel()] = 10**4.3
            ...
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_'+blid+'_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_csm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.png', bbox_inches=0)
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_'+blid+'_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_csm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.eps', bbox_inches=0)
        ...
        for j in xrange(len(select_bl_id)):
            blid = select_bl_id[j]
            axs[j].plot(1e6*clean_lags, NP.abs(dsm_cc_skyvis_lag[ref_bl_id == blid,:,1]).ravel(), 'r-', lw=2, label='Diffuse')
            axs[j].plot(1e6*clean_lags, NP.abs(csm_cc_skyvis_lag[ref_bl_id == blid,:,1]).ravel(), ls='-', lw=2, label='Compact', color='cyan')
            axs[j].plot(1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[ref_bl_id == blid,:,1]).ravel(), 'k-', lw=2, label='Both')
    ...
    if plot_11:
        ...
        for j in xrange(n_snaps):
            ...
            for i in xrange(n_bins_baseline_orientation):
                ...
                imdspec = axs[n_bins_baseline_orientation-1-i].pcolorfast(truncated_ref_bl_length[blind[sortind]], 1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[truncated_ref_bl_ind,:,:][blind[sortind][:-1],:-1,j].T), norm=PLTC.LogNorm(vmin=1e6, vmax=dspec_max))
            ...
            cbax.xaxis.tick_top()
            cbax.set_ylabel('Jy Hz', fontsize=12, rotation='horizontal')
    ...
    if plot_12:
        ...
        for j in xrange(n_snaps):
            ...
            for k in xrange(len(required_bl_orientation)):
                ...
                blind = blori[blori[i]:blori[i+1]]
                sortind = NP.argsort(truncated_ref_bl_length[blind], kind='heapsort')
                imdspec = axs[k].pcolorfast(truncated_ref_bl_length[blind[sortind]], 1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[truncated_ref_bl_ind,:,:][blind[sortind][:-1],:-1,j].T), norm=PLTC.LogNorm(vmin=1e6, vmax=dspec_max))
            ...
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_N_E_binned_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'_snapshot_{0:0d}.png'.format(j), bbox_inches=0)
            PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_N_E_binned_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'_snapshot_{0:0d}.eps'.format(j), bbox_inches=0)
    ...
    if plot_13:
        ...
        ns_fg_contamination = OPS.rms(asm_cc_skyvis_lag[ns_blind,:,0], mask=NP.logical_not(small_delays_strict_EoR_window[:,ns_blind]).T)
        ew_blind = blori[blori[1]:blori[1+1]]
        ew_fg_contamination = OPS.rms(asm_cc_skyvis_lag[ew_blind,:,0], mask=NP.logical_not(small_delays_strict_EoR_window[:,ew_blind]).T)
        for i in xrange(n_blo_remove_range):
            ...
            for j in xrange(n_inner_bll_remove_range):
                ...
                bl_screened_fg_contamination[i,j] = OPS.rms(asm_cc_skyvis_lag[:,:,0], mask=mask.T)
        ...
        for i in xrange(n_blo_remove_range):
            ax1.plot(inner_bll_remove_max, NP.abs(bl_screened_fg_contamination[i,:]), marker=symbols[i], markersize=6, lw=1, color='k', ls='-', label=r'$|\theta_b|\,\leq\,${0:.1f}$^\circ$'.format(blo_remove_max[i]))
        ...
        ax1.set_ylim(0.5*NP.abs(bl_screened_fg_contamination).min(), 1.2*NP.abs(bl_screened_fg_contamination).max())
        ...
        ax1.set_ylabel('Foreground Contamination [Jy Hz]', fontsize=18, weight='medium')
        ...
        PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_screening_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.png', bbox_inches=0)
        PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'baseline_screening_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.eps', bbox_inches=0)
    ...
    if plot_14:
        ...
        fig, axs = PLT.subplots(2, sharex=True, sharey=True, figsize=(6,6))
        all_imdspec = axs[0].pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(asm_cc_skyvis_lag[:-1,:-1,0].T), norm=PLTC.LogNorm(vmin=5e5, vmax=1e10))
        screened_imdspec = axs[1].pcolorfast(truncated_ref_bl_length, 1e6*clean_lags, NP.abs(bl_screened_asm_cc_skyvis_lag[:-1,:-1].T), norm=PLTC.LogNorm(vmin=5e5, vmax=1e10), cmap=colrmap)
        ...
        PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'multi_baseline_screening_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.png', bbox_inches=0)
        PLT.savefig('/data3/t_nithyanandan/project_MWA/figures/'+telescope_str+'multi_baseline_screening_CLEAN_noiseless_visibilities_'+ground_plane_str+snapshot_type_str+obs_mode+'_gaussian_FG_model_asm'+sky_sector_str+'nside_{0:0d}_'.format(nside)+'Tsys_{0:.1f}K_{1:.1f}_MHz_{2:.1f}_MHz_'.format(Tsys, freq/1e6,nchan*freq_resolution/1e6)+bpass_shape+'{0:.1f}'.format(oversampling_factor)+'.eps', bbox_inches=0)
